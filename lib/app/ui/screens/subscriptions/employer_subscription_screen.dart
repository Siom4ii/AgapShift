...
/// Employer paid tier: unlimited job posts and hires after the first free listing.
///
/// Billing is a stub until a payment provider is integrated.
class EmployerSubscriptionScreen extends StatefulWidget {
  const EmployerSubscriptionScreen({super.key, required this.session});
      ...
      if (id.isNotEmpty) {
        try {
          final row = await Supabase.instance.client
              ...
              .select('subscription_expires_at, verification_fee_paid_until')
              .eq('business_id', id)
              .maybeSingle();
          final sub = row?['subscription_expires_at'];
          final leg = row?['verification_fee_paid_until'];
          if (sub != null) {
            exp = DateTime.parse(sub as String);
          } else if (leg != null) {
            exp = DateTime.parse(leg as String);
          }
        } catch (_) {}
      }
    }
          ...
          child: Column(
            ...
            children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [Color(0xFF065F46), Color(0xFF86EFAC)],
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Your employer subscription is now active.',
                          style: GoogleFonts.inter(
                            fontSize: 13.5,
              ...
              const _SubPrivilegeRow(
                ...
                text: 'Post unlimited job listings',
              ...
              const _SubPrivilegeRow(
                ...
                text: 'Continue hiring without posting restrictions',
                accent: Color(0xFF065F46),
                bg: Color(0xFFD1FAE5),
              ),
              const SizedBox(height: 10),
              const _SubPrivilegeRow(
                ...
                text: 'Continuous recruitment during the subscription period',
                accent: Color(0xFF065F46),
                bg: Color(0xFFD1FAE5),
              ),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: const LinearGradient(
                      colors: [Color(0xFF065F46), Color(0xFF16A34A), Color(0xFF86EFAC)],
                      begin: Alignment.topLeft,
                      end: Alignment.bottomRight,
                    ),
                    boxShadow: [
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Unlimited posts + unlimited hires',
                                  style: GoogleFonts.inter(
                                    fontSize: 12.5,
                                    fontWeight: FontWeight.w600,
                      ...
                      if (active && _expiresAt != null)
                        ...
                        Text(
                          'First job post is free. From your second listing onward, subscribe to keep posting.',
                          style: GoogleFonts.inter(
                            fontSize: 12.5,
                            fontWeight: FontWeight.w600,
                            color: Colors.white.withValues(alpha: 0.92),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Free tier: your first job posting is free, regardless of headcount. '
                          'After that, an active subscription is required for unlimited posting and hiring.',
                          style: GoogleFonts.inter(
                            fontSize: 13.5,
                            fontWeight: FontWeight.w600,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              '₱${RevenueStubService.employerSubscriptionPhp}/mo',
                              style: GoogleFonts.inter(
                                fontSize: 12,
                                fontWeight: FontWeight.w900,
                                color: statusColor,
                      ...
                      const _PerkRow(
                        icon: Icons.autorenew_rounded,
                        text: 'Continuous recruitment while subscribed',
                        accent: Color(0xFF065F46),
                        bg: Color(0xFFD1FAE5),
                      ),
                    ],
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text(
                              '₱${RevenueStubService.postBoostPhp} per boosted post · '
                              '${RevenueStubService.postBoostValidity.inDays} days top placement in worker feeds.',
                              style: GoogleFonts.inter(
                                fontSize: 12.5,
                                fontWeight: FontWeight.w600,
